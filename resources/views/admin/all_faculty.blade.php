      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
          ...
          <tr>
            ...
            <!-- <td>
            <a href="" class="active" ui-toggle-class="">Liệt kê ngành</a>
            </td> -->
            ...
            <td>
              ...
              <a onclick="return confirm('Bạn có chắc muốn xóa?')" href="{{URL::to('/delete-faculty/'.$cate_pro->khoa_id)}}" class="active" ui-toggle-class=""> 
